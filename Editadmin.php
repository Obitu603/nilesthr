...
<head>
    ...
    <title>NILEST HR Registeration</title>
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                           <center> <div class="card-text">
                                <h1 class="h4 text-gray-900 mb-4">EDIT ADMIN RECORD 
                            ...
                            <?php
                                ...
                                {   $id =mysqli_real_escape_string($connection, $_GET['id']);
                                    $query = "SELECT *FROM hradmin_reg WHERE id='$id'";
                                       ...
                                       ?>
                                            ...
                                            <form action="code.php" method="POST">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control"value="<?=$id['username'];?>" name="Username" aria-describedby="emailHelp">
                                                    </div>
                                                    <div class="mb-3">
                                                    <label  class="form-label">Email address</label>
                                                    <input type="email" class="form-control" value="<?=$id['email'];?>" name="Email" aria-describedby="emailHelp">
                                                    </div>
                                                    <div class="mb-3">
                                    ...
                                    <center> <a href="admin_reg.php" class="btn btn-danger float-end">Back</a>
