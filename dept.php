...
<!DOCTYPE html>
    ...
    <body id="page-top">
        ...
        <h1 class="text-center">Department Staff</h1>
        <div class="row">
            <!-- Staff Member 1 -->
            <div class="col-md-4">
                <div class="staff-card">
                    <img src="staff1.jpg" alt="Staff Member 1" class="staff-image">
                    <h3>John Doe</h3>
            ...
            <div class="col-md-4">
                <div class="staff-card">
                    <img src="staff2.jpg" alt="Staff Member 2" class="staff-image">
                    <h3>Jane Smith</h3>
            ...
            <div class="col-md-4">
                <div class="staff-card">
                    <img src="staff3.jpg" alt="Staff Member 3" class="staff-image">
