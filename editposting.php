                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                           <center> <div class="card-text">
                                <h1 class="h4 text-gray-900 mb-4">EDIT POSTING RECORD
                            ...
                            <?php
                                ...
                                {   $id =mysqli_real_escape_string($connection, $_GET['id']);
                                    $query = "SELECT *FROM posting_record WHERE id='$id'";
                        ...
                        <input type="text" class="form-control" name="postingLocation" value="<?=$id['posting_location'];?>">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Posting Start Date</label>
                        <input type="date" class="form-control" name="postingStartDate"value="<?=$id['postingStartDate'];?>">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Posting End Date</label>
                        <input type="date" class="form-control" name="postingEndDate"value="<?=$id['postingEndDate'];?>">
                    </div>
