                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                           <center> <div class="card-text">
                                <h1 class="h4 text-gray-900 mb-4">EDIT PLACES TRAVELLED
                            ...
                            <?php
                                ...
                                {   $id =mysqli_real_escape_string($connection, $_GET['id']);
                                    $query = "SELECT *FROM places_travelled WHERE id='$id'";
                                ...
                                <input type="text" class="form-control" name="destination"id="destination"value="<?=$id['destination'];?>">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Purpose</label>
                                <input type="text" class="form-control" name="purpose" id="purpose" value="<?=$id['purpose'];?>">
                            </div>
                            <div class="mb-3">
