                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                           <center> <div class="card-text">
                                <h1 class="h4 text-gray-900 mb-4">EDIT ASSOCIATION RECORD
                            ...
                            <?php
                                ...
                                <option>Select Association----</option>    
                                    ...
                                    <option value="ASURI">ASURI</option>
                                                    ...
                                                    <input type="date" class="form-control" value="<?=$id['Datejoined'];?>" name="Email" aria-describedby="emailHelp">
                                                    </div>
                                                   
                                    <center> <a href="admin_2.php" class="btn btn-danger float-end">Back</a>
                                    <button type="submit" name="UpdateAssRecord" class="btn btn-primary">Update Record</button></center>
                                </form>
                                  <?php
                                    }
                                    else
