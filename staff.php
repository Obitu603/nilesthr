...
<!DOCTYPE html>
    ...
    <body id="page-top">
        ...
        <div class="row">
            <div class="col-md-4">
                <!-- User picture -->
                <img src="img/pic2.jpg" alt="User Picture" class="img-fluid rounded-circle">
            </div>
            <div class="col-md-8">
                <!-- User information -->
                <h1><?php
                ...
                <p>About Me:</p>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam eget purus nec augue commodo blandit.</p>
            </div>
        </div>
    </div>
